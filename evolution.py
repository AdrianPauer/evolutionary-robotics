...
parser.add_argument("--obs-type", choices=("ray", "food"), default="ray", help="Observation type used by the robot.")
...
parser.add_argument("--max-steps", default=350, type=int, help="Maximum steps per rollout.")
...
def evolve_pygad(
    ...
    def on_generation(ga_instance):
        ...
        print(f"PyGAD generation {generation}: best={solution_fitness:.2f}")
